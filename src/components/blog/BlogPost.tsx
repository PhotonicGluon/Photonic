...
export default class BlogPost extends Component<Props, State> {
    render(props: Props, state: State) {
        ...
        return (
            <a
                href={"/blog/" + post.slug}
                class="h-min transition-transform duration-300 ease-out *:text-white hover:cursor-pointer hover:not-print:scale-105 focus:scale-105 print:*:text-black"
            >
                <article class="blog-post flex flex-col border border-gray-700 bg-gray-900 print:bg-white">
                    {/* Preamble */}
