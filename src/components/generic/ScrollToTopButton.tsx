...
export default class ScrollToTopButton extends Component<Props, State> {
    ...
    render() {
        return (
            <div
                class={
                    "fixed right-4 bottom-20 z-50 flex size-12 items-center justify-center rounded-full bg-linear-to-r from-indigo-800 to-blue-600 shadow-xl transition-all duration-200 hover:bg-cyan-900 lg:size-14 xl:right-20 print:hidden " +
